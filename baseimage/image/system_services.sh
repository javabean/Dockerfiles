...
#curl -o /usr/local/bin/tini -fsSLR https://github.com/krallin/tini/releases/download/v0.10.0/tini-static
curl -o /usr/local/bin/tini -fsSLR https://github.com/krallin/tini/releases/download/v0.10.0/tini
chmod +x /usr/local/bin/tini
curl -o /usr/local/bin/dumb-init -fssLR https://github.com/Yelp/dumb-init/releases/download/v1.1.3/dumb-init_1.1.3_amd64
