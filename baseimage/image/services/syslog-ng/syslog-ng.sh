...
# syslog group (owning group of /var/log/syslog) is adm, not syslog!
# patching this to make logrotate work!
sed -i'.bak' 's/su root syslog/su root adm/'  /etc/logrotate.conf
